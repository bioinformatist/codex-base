...
jq -e '
  [
    ...
    [.lunaLow.profile,.lunaLow.model,.lunaLow.reasoningEffort,.lunaLow.verbosity,.lunaLow.sandbox,.lunaLow.approval,.lunaLow.networkAccess,.lunaLow.tokenLimit,.lunaLow.initialTimeout,.lunaLow.followupTimeout],
    ...
    ["improve-executor-luna-low","gpt-5.6-luna","low","medium","workspace-write","never",true,100000,1200,720],
  ...
  and (.lunaLow.reminders == [50000,25000,10000])
...
for profile in improve-scout improve-executor improve-executor-spark improve-executor-luna-low improve-executor-deep improve-reviewer improve-elegance-reviewer; do
...
require_text "$skill" 'version: "1.0.0-codex.16"'
require_text "$planning" "Contract version: \`1.0.0-codex.16\`"
require_text "$template" "**Improve contract**: \`1.0.0-codex.16\`"
